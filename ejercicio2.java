public class ejercicio2 {   //ves algun error en el precio?
...
*/
    public static void main(String[] args) {//1 kilo son 1000 g es decir que
        double preciode1kilo = 5.95 * 10;
        System.out.println("el precio por kilo es "+preciode1kilo);
    //no es correcto el precio ya que segun el calculo da 59.5 el kg
